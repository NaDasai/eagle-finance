...
describe.skip('Scenario 1: Add liquidity, Swap, Remove liquidity without feees', async () => {
  beforeAll(async () => {
...
describe.skip('Scenario 2: Add liquidity, Swap native coins in and out without fees', async () => {
  beforeAll(async () => {
    registryContract = await deployRegistryContract(user1Provider, wmasAddress);
...
describe.skip('Oracle TWAP tests', () => {
  beforeAll(async () => {
    registryContract = await deployRegistryContract(user1Provider, wmasAddress);
    // create new pool
    await createNewPool(
...
describe.skip('Scenario 4: Add liquidity using different token decimals wmas(9 decimals) and token A (18 decimals)', async () => {
  beforeAll(async () => {
...
describe.skip('Scenario 5: Add liquidity and swap with different token decimals wmas(9 decimals) and token A (18 decimals)', async () => {
  beforeAll(async () => {
    // another token that its decimals are 18
    aTokenAddress = 'AS12mmxJw7XF4iRpMpuMbYLcs2xX6EUKT9E9Bs7hzPPUxPk5ZZsaN';
    poolFeeRate = 0.3 * 10_000;
